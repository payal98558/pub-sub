...
# python streamProcess.py \
#   --project=potent-bloom-299523 \
#   --region=US\
#   --input_topic=projects/potent-bloom-299523/topics/TopicDemo \
#   --output_path=gs://bigquery_demo/pusub/output \
#   --runner=DataflowRunner \
#   --window_size=2 \
#   --temp_location=gs://bigquery_demo/pusub/temp